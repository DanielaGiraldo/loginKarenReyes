...
$('#tipo_rural').change(function(event){
	var cambiar = $(this).val();

	if(cambiar == 'corregimiento'){
	$('#comuna').css('display', 'none');
	$('#barrio').css('display', 'block');
	$('#tipo_corregimientos').css('display', 'block');
	$('#tipo_veredas').css('display', 'none');
	$('#tipo_rural').css('display', 'block');

}else if (cambiar == 'vereda'){
		$('#comuna').css('display', 'none');
		$('#tipo_corregimientos').css('display', 'block');
		$('#tipo_veredas').css('display', 'block');
		$('#barrio').css('display', 'none');
		$('#tipo_rural').css('display', 'block');

	}else if (cambiar == 'seleccionar'){
		$('#comuna').css('display', 'none');
		$('#tipo_corregimientos').css('display', 'none');
		$('#tipo_veredas').css('display', 'none');
		$('#barrio').css('display', 'none');
		$('#tipo_rural').css('display', 'none');
	}
